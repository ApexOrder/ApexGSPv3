...
export type NodeAction = 'status' | 'start' | 'stop' | 'restart' | 'logs' | 'metrics' | 'config' | 'backup_list' | 'backup_create' | 'backup_delete' | 'backup_restore' | 'backup_restore_world' | 'backup_restore_full'
